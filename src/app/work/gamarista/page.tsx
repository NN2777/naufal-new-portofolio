...
import { SiCss, SiHtml5, SiJavascript, SiLaravel } from "react-icons/si";
...
const projectLinks = [
  {
    label: "Visit Site",
    href: "https://www.gamaristastudio.com/",
  },
];

const involvement = [
  "Implemented the official website layout for Gamarista Studio based on the studio profile and visual direction.",
  "Built responsive website sections for company profile, services, projects, gallery, and contact information.",
  "Worked on public-facing page structure so visitors can quickly understand the studio, its work, and its brand identity.",
  "Supported website deployment and presentation for a live public website.",
];

export default function GamaristaStudioPage() {
  return (
    <main className="min-h-screen bg-[#0B0F14] text-white">
      <section className="px-5 py-10 md:px-10 lg:px-16">
        <div className="mx-auto w-full max-w-5xl">
          {/* Hero */}
          <div className="mt-12">
            <p className="font-mono text-sm text-cyan-300">Official Website</p>

            <h1 className="mt-4 text-5xl font-bold tracking-tight text-white md:text-6xl">
              Gamarista Studio Official Website
            </h1>

            <p className="mt-6 max-w-3xl text-base leading-8 text-slate-400 md:text-lg">
              Official website for Gamarista Studio, built to present the studio
              profile, services, projects, gallery, and brand identity through a
          ...
          <section className="mt-14">
            <div className="group overflow-hidden rounded-3xl border border-white/10 bg-white/[0.025] transition duration-300 hover:border-cyan-400/30 hover:bg-cyan-400/[0.025]">
              <div className="relative aspect-[2/1] bg-[#10151c]">
                <Image
                  src="/images/work/gamarista/gamarista-home.png"
                  alt="Gamarista Studio official website preview"
                  fill
                  priority
                  sizes="(max-width: 1024px) 100vw, 960px"
                  className="object-contain object-top transition duration-700 group-hover:scale-[1.02] group-hover:brightness-110"
                />
            ...
            <div className="mt-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
              <p className="text-sm text-slate-500">
                Official website preview and related project links.
              </p>
          ...
          <section className="mt-14 border-t border-white/10 pt-10">
            ...
            <p className="mt-5 max-w-3xl text-sm leading-7 text-slate-400 md:text-base md:leading-8">
              The website gave Gamarista Studio a structured public online
              presence to present its profile, services, projects, gallery, and
              brand identity in a responsive format.
            </p>
          </section>
